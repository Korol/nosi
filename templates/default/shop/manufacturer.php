	...
	<div class="content1Struct1">
		...
		<div class="content1Struct1I">
			...
			if(!empty($manufacturer_res->description)){
				?><div class="brandDesc">
				<!-- Block of brand image  -->
				<div class="brand_img">                <?php
                    if(isset($manufacturer_res->image))
                    {
                        ?><img src="<?php print '/' . $manufacturer_res->image->file_path . $manufacturer_res->image->file_name; ?>"><?
                    }
                ?>
                </div>
				<!-- Block of brand image END -->
