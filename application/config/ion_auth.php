 ...
 */
$config['site_title']           = "nosieto.com.ua"; 		// Site Title, example.com
$config['admin_email']          = "noreply@nosieto.com.ua"; 	// Admin Email, admin@example.com
$config['default_group']        = 'members'; 			// Default group, use name
$config['admin_group']          = 'admin'; 				// Default administrators group, use name
$config['identity']             = 'email'; 	//username			// A database column which is used to login with
