		...
		if ( $this->ion_auth_model->forgotten_password($identity) )   //changed
		{
			...
			if ($user)
			{
				...
				else
				{
					...
					{
						$this->set_error('forgot_password_unsuccessful_no_email');
						return FALSE;
					}
				}
			}
			...
			{
				$this->set_error('forgot_password_unsuccessful_no_user');
				return FALSE;
			}
		}
		else
		{
			$this->set_error('forgot_password_unsuccessful_no_identity');
			return FALSE;
		}
	}
