...
<!--    /favicons-->
    ...
    <script>
        ...
        fbq('init', '1165356570165632'); // Insert your pixel ID here.
        fbq('track', 'PageView');
        <?=(!empty($fb_pixel_event)) ? $fb_pixel_event : ''; ?>
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=1165356570165632&ev=PageView&noscript=1"
            /></noscript>
    <!-- DO NOT MODIFY -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <form method="post" method="/login.html" class="form-inline">
                    <div class="form-group">
                        <label class="sr-only" for="login_name">Email</label>
                        <input type="text" class="form-control" id="login_name" name="login_name" placeholder="Email">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer text-center clearfix">
                <a class="pull-left" href="#" data-dismiss="modal" data-toggle="modal" data-target="#myModal1">Вспомнить<br/>пароль</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="remail"><span class="necessary">*</span> Email:</label>
    ...
    <div id="top-wrapper">
        <div class="row">
            <div class="col-lg-3 col-lg-offset-9">
                ...
                <div class="tw-phones">(097)003-22-33</div>
                <div class="tw-viber"></div>
                <div class="tw-phones">(050)43-43-123</div>
                <div class="clear"></div>
            </div>
        </div>
    </div>
