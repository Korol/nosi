...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		_afterLoad: function () {
			...
			if($(".topRight .price .current").length>0){
				$(".fancybox-inner").next(".inner-after").remove();
				html+='<div class="inner-after">';
				html+='<div class="inner-after-buy"><button onclick="shop_product_cart(this,'+product_id+',1,\'add\'); return false;" type="button"><span>Купить</span></button></div>';
				html+='<div class="inner-after-price">'+$(".topRight .price .current").text()+'</div>';
				html+='</div>';
			}
			$(".fancybox-inner").after(html);
		},
